...
-- Volcando datos para la tabla inventory.barcodes: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.business: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.business_locations: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.contacts: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.currencies: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.invoice_layouts: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.invoice_schemes: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.model_has_roles: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.notification_templates: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.permissions: ~17 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.reference_counts: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.roles: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.role_has_permissions: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.units: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla inventory.users: ~0 rows (aproximadamente)
